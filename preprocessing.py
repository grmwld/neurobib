...
DEFAULT_FILTERS = [str.lower, unicode.lower, strip_tags, strip_punctuation, strip_multiple_whitespaces,
                   strip_numeric, remove_stopwords, strip_short, stem_text]

def preprocess_string(s, filters=DEFAULT_FILTERS, debug=False):
    for f in filters:
        try:
            s = f(s)
